...
public class StudentJdbc {
    ...
    public int CreateStudent(Student student) {
        ...
        return this.jdbcTemplate.update(
                ...
                student.getName(),student.getSecond_name(), student.getStudy_group_id()
        );
    }
    ...
    public int UpdateStudent(Student student) {
        ...
        int status = jdbcTemplate.update("UPDATE STUDENT SET `SURNAME` = ?, `NAME` = ?,`SECOND_NAME` = ?,`STUDY_GROUP_ID` = ? WHERE id = ?",
                student.getSurname(),
                student.getName(),student.getSecond_name(), student.getStudy_group_id(), student.getId());
        if(status == 0){
